// BiteProof verify + admin + download in one module (Vercel serverless)
// Routes:
...
const PEPPER = process.env.ACCESS_PEPPER || 'biteproof-pepper-f6c0742a';

const FILES = [
  'core-guide.pdf',
  'yard-audit.pdf',
  'standing-water-kill-list.pdf',
  'repellent-cheat-sheet.pdf',
  'barrier-blueprint.pdf',
  'bite-response-card.pdf',
  'outing-playbook.pdf',
  'season-tracker.pdf',
];
